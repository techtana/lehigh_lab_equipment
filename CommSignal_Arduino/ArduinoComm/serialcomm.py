...
from ArduinoComm import serialgui
...
class ThreadedSlackComm:
    def __init__(self, root, ser):
        ...
        self.gui = serialgui.GuiPart(root)
        self.ser = ser
    ...
    def processIncoming(self):
        ...
        while self.queue.qsize():
            ...
            try:
                ...
                parsed_msg = messenger.parser(msg)
                messenger.send_message_to_slack(parsed_msg)  # to container SlackComm
                self.startThread()
            except queue.Empty:
                pass
